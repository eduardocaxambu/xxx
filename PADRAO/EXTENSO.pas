...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Mestre, Vcl.StdCtrls;

type
  TExtensof = class(TMestre_FRM)
    Label1: TLabel;
    Edit1: TEdit;
    Edit2: TEdit;
    Edit3: TEdit;
...
procedure TExtensof.Button1Click(Sender: TObject);
